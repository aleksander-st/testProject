...
const meta={title:'Components/OptionCard',component:OptionCard,tags:['autodocs'],args:{title:'Ubuntu 24.04',description:'Рекомендуемый образ',state:'default'},argTypes:{title:{control:'text'},description:{control:'text'},state:{control:'inline-radio',options:states},disabled:{control:'boolean'},onClick:{control:false}},parameters:{layout:'centered'}} satisfies Meta<typeof OptionCard>
export default meta
