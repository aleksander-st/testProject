...
const meta={title:'Components/Table',component:Table,tags:['autodocs'],args:{density:'default'},argTypes:{density:{control:'inline-radio',options:densities}},parameters:{layout:'padded'}} satisfies Meta<typeof Table>
export default meta
